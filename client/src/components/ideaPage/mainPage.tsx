						...
						<div className="flex items-center justify-between px-4 py-4">
							...
							<DropdownMenu>
								<DropdownMenuTrigger asChild>
									<Button variant="outline" className="h-8 cursor-pointer bg-white gap-1.5 rounded-md px-2.5 text-xs font-medium">
						...
						{loading ? (
							...
							<div className="min-h-0 flex-1 space-y-3 overflow-y-auto bg-muted/20 sm:px-4 ">
								{articles.map((article) => (
									<article key={article.id} onClick={() => void openArticle(article)} className="group cursor-pointer rounded-lg shadow-sm bg-card p-3 transition-colors hover:bg-red-50/10 sm:p-4">
