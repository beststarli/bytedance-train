...
export default function UserPage({ onNavigate }: UserPageProps) {
  ...
  return (
    <div className="enter-workspace flex-1 overflow-y-auto px-4 py-2 sm:px-7">
      <div className="mx-auto max-w-[1240px] space-y-5">
        ...
        <section className="workspace-card p-5 sm:p-6">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {[
              { title: "发布文章", desc: "进入自由写作台，编辑并发布内容", icon: FilePenLine, tone: "bg-red-50 text-red-500", target: "create:manual" },
